...
class MosrangeSelector(Selector):
    ...
    def run_with_different_init_layouts(self):
        ...
        initial_layouts = self.initLayoutsSelector.get_complement_surrounding_layouts(layout, layout_r)
    ...
    def run_with_main_init_layouts_algos(self):
        ...
        initial_layouts = self.initLayoutsSelector.get_complement_surrounding_layouts(layout, moselect_layout_r)
        ...
        initial_layouts = self.initLayoutsSelector.get_complement_surrounding_layouts(layout, compmoselect_layout_r)
