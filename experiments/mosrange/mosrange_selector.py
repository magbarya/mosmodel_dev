...
from init_layouts import InitLayoutsSelector
...
class MosrangeSelector(Selector):
    def __init__(
        ...
        # initial layouts selector
        self.initLayoutsSelector = InitLayoutsSelector(
            memory_footprint_file, pebs_mem_bins_file,
            exp_root_dir, results_dir, run_experiment_cmd,
            num_layouts, num_repeats, metric_name, debug)
    ...
    def run_with_main_init_layouts_algos(self):
        ...
        initial_layouts = self.initLayoutsSelector.get_moselect_distinct_init_layouts()
        compmoselect_layout_r, _ = self.run_with_custom_init_layouts(initial_layouts, shake_budget, group_details="compmoselect")

        layout = moselect_layout_r['hugepages']
        initial_layouts = self.get_complement_surrounding_layouts(layout, moselect_layout_r)
        compo_compmoselect_layout_r, _ = self.run_with_custom_init_layouts(initial_layouts, shake_budget, group_details="complement moselect layout")
        ...
        layout = compo_compmoselect_layout_r['hugepages']
        initial_layouts = self.get_complement_surrounding_layouts(layout, compo_compmoselect_layout_r)
        self.run_with_custom_init_layouts(initial_layouts, shake_budget, group_details="complement complement moselect layout")
    ...
    def run(self):
        ...
        # self.run_with_main_init_layouts_algos()
