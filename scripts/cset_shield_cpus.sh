...
sudo cset shield --cpu=$ALL_CPUS --userset=node0_cset --kthread=on
...
# turn-off load balancing for kernel threads
# echo 0 | sudo tee /sys/fs/cgroup/cpuset/node*/cpuset.sched_load_balance
